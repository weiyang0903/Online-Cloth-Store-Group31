...
<head>
    ...
    <style>
        ...
        body {
        background-image: url(./cuspic/kids.png);
...
<body>
    ...
    <div class="cate">
        <div class="cate1">
            <img src="../product_picture/kids/KIDS.jpg" alt="kid">
        </div>
    </div>
    ...
    <section id="cloth">
        <!-- cloth -->
        <div class="cate2">
             <div class="cate3"><img src="../product_picture/kids/kid_cloth.jpg" alt="cloth"></div>
             <div class="cate4">
             <?php
                $haha = "SELECT productname, productid, categoryid, category2id, product_picture, productdescription, productprice FROM product WHERE category2id = 'T01' AND categoryid = 'C003' GROUP BY productname;";
    ...
    <!-- pant -->
    <div class="cate2">
        <div class="cate3_5"><img src="../product_picture/kids/kid_pant.jpg" alt="pant"></div>
        <div class="cate4_5">
        <?php
                $haha = "SELECT productname, productid, categoryid, category2id, product_picture, productdescription, productprice FROM product WHERE category2id = 'T02' AND categoryid = 'C003' GROUP BY productname;";
                $result = mysqli_query($connect,$haha);
   ...
   <section id="jacket">
        <!-- jacket -->
    <div class="cate2">
        <div class="cate3"><img src="../product_picture/kids/kid_jacket.jpg" alt="jacket"></div>
        <div class="cate4">
        <?php
                $haha = "SELECT productname, productid, categoryid, category2id, product_picture, productdescription, productprice FROM product WHERE category2id = 'T06' AND categoryid = 'C003' GROUP BY productname;";
                $result = mysqli_query($connect,$haha);
   ...
   <section id="doll">
    <!-- doll -->
    <div class="cate2">
        <div class="cate3_5"><img src="../product_picture/kids/kid_doll.jpg" alt="doll"></div>
        <div class="cate4_5">
        <?php
                $haha = "SELECT productname, productid, categoryid, category2id, product_picture, productdescription, productprice FROM product WHERE category2id = 'T08' AND categoryid = 'C003' GROUP BY productname;";
                $result = mysqli_query($connect,$haha);
