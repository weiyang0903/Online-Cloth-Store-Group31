...
<head>
    ...
    <style>
        body {
        background-image: url(./cuspic/women.jpg);
...
<body>
    ...
    <div class="cate">
        <div class="cate1"><img src="../product_picture/women/women.jpg" alt="women"></div> 
    </div>

    <section id="cloth">
        <!-- cloth -->
        <div class="cate2">
             <div class="cate3"><img src="../product_picture/women/women_cloth.jpg" alt="cloth"></div>
             <div class="cate4">
             <?php
                $haha = "SELECT productname, productid, categoryid, category2id, product_picture, productdescription, productprice FROM product WHERE category2id = 'T01' AND categoryid = 'C001' GROUP BY productname;";
    ...
    <!-- pant -->
    <div class="cate2">
        <div class="cate3_5"><img src="../product_picture/women/women_pant.jpg" alt="pant"></div>
        <div class="cate4_5">
        <?php
                $haha = "SELECT productname, productid, categoryid, category2id, product_picture, productdescription, productprice FROM product WHERE category2id = 'T02' AND categoryid = 'C001' GROUP BY productname;";
                $result = mysqli_query($connect,$haha);
   ...
   <section id="skirt/dress">
        <!-- skirt/dress -->
    <div class="cate2">
        <div class="cate3"><img src="../product_picture/women/women_skirt.jpg" alt="skirt"></div>
        <div class="cate4">
        <?php
                $haha = "SELECT productname, productid, categoryid, category2id, product_picture, productdescription, productprice FROM product WHERE category2id = 'T03' AND categoryid = 'C001' GROUP BY productname;";
                $result = mysqli_query($connect,$haha);
   ...
   <section id="tie">
    <!-- Tie -->
    <div class="cate2">
        <div class="cate3_5"><img src="../product_picture/women/women_tie.jpg" alt="tie"></div>
        <div class="cate4_5">
        <?php
                $haha = "SELECT productname, productid, categoryid, category2id, product_picture, productdescription, productprice FROM product WHERE category2id = 'T04' AND categoryid = 'C001' GROUP BY productname;";
                $result = mysqli_query($connect,$haha);
...
<section id="socks">
    ...
    <div class="cate2">
        ...
        <div class="cate4">
        <?php
                $haha = "SELECT productname, productid, categoryid, category2id, product_picture, productdescription, productprice FROM product WHERE category2id = 'T05' AND categoryid = 'C001' GROUP BY productname;";
                $result = mysqli_query($connect,$haha);
...
<section id="jacket">
    <!-- jacket -->
    <div class="cate2">
     <div class="cate3_5"><img src="../product_picture/women/Jacket.jpg" alt="jacket"></div>
     <div class="cate4_5">
     <?php
                $haha = "SELECT productname, productid, categoryid, category2id, product_picture, productdescription, productprice FROM product WHERE category2id = 'T06' AND categoryid = 'C001' GROUP BY productname;";
                $result = mysqli_query($connect,$haha);
...
{
    const scrollPosition = localStorage.getItem('scrollPosition1');
    if (scrollPosition !== null) {
        window.scrollTo(0, parseInt(scrollPosition, 10));
        localStorage.removeItem('scrollPosition1');
    }
});

window.addEventListener('beforeunload1', function()
{
    localStorage.setItem('scrollPosition1', window.scrollY);
});
</script>
<?php
    if (isset($_POST["hi"]))
